<div class="content">
    ...
    <div class="row justify-content-center py-20">
        <div class="col-xl-12">
            <form action="{$.php.set_url($.const.ADMIN_URL~'/iblock/content_edit_save?iblock='~$iblock_select~'&content='~$content_select, false)}" novalidate="novalidate" method="post" onsubmit="return false;">
