<div class="content">
    ...
    <div class="row justify-content-center py-20">
        <div class="col-xl-12">
            <form action="{$.php.set_url($.const.ADMIN_URL~'/news/add_save', false, false)}" novalidate="novalidate" method="post" onsubmit="return false;">
                        ...
                        {foreach $language_list as $lg => $name_lg first=$first}
                            <div class="tab-pane fade {if $first}show active{/if}" id="btabs-{$lg}" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="val-title-{$lg}" name="news[{$lg}][title]" value="" placeholder="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-url-{$lg}">URL</label>
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="val-url-{$lg}" name="news[{$lg}][url]" value="" placeholder="#">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-img-{$lg}">IMG</label>
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="val-img-{$lg}" name="news[{$lg}][img]" value="" placeholder="#">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <textarea rows="10" name="news[{$lg}][body]" class="form-control textarea"></textarea>
                                    </div>
                                </div>
                ...
                <div class="block block-rounded">
                    <div class="block-content">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" id="val-desc" name="author" value="Admin" placeholder="Author">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="datetime-local" class="form-control" id="val-url" name="date" value="" placeholder="Date">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="custom-control custom-radio custom-control-inline mb-5">
                                    <input class="custom-control-input" type="radio" name="fixed" id="fixed1" value="1">
                                    <label class="custom-control-label" for="fixed1">Yes</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline mb-5">
                                    <input class="custom-control-input" type="radio" name="fixed" id="fixed2" value="0" checked="">
