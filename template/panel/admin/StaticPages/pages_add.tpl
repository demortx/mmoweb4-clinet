<div class="content">
    ...
    <div class="row justify-content-center py-20">
        <div class="col-xl-12">
            <form action="{$.php.set_url($.const.ADMIN_URL~'/pages/add_save', false, false)}" novalidate="novalidate" method="post" onsubmit="return false;">
                ...
                <div class="block block-rounded">
                    <div class="block-content">
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" id="val-desc" name="desc" value="" placeholder="Description">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" id="val-url" name="url" value="" placeholder="about/server-x10">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="custom-control custom-radio custom-control-inline mb-5">
                                    <input class="custom-control-input" type="radio" name="show" id="show1" value="true" checked="">
                                    <label class="custom-control-label" for="show1">Yes</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline mb-5">
                                    <input class="custom-control-input" type="radio" name="show" id="show2" value="false">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="custom-control custom-radio custom-control-inline mb-5">
                                    <input class="custom-control-input" type="radio" name="template" id="dis1" value="site" checked="">
                                    <label class="custom-control-label" for="dis1">{$StaticPages_show_btn_site}</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline mb-5">
                                    <input class="custom-control-input" type="radio" name="template" id="dis2" value="panel">
                        ...
                        {foreach $language_list as $lg => $name_lg first=$first}
                            <div class="tab-pane fade {if $first}show active{/if}" id="btabs-{$lg}" role="tabpanel">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="val-title-{$lg}" name="page[{$lg}][title]" value="" placeholder="">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <textarea rows="10" name="page[{$lg}][body]" class="form-control textarea"></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="val-meta_title" name="page[{$lg}][meta_title]" value="" placeholder="MmoWeb Личный кабинет сервер Gracia Final!">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-meta_description">meta:description</label>
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="val-meta_description" name="page[{$lg}][meta_description]" value="" placeholder="Крупнейший классический Lineage 2...">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-4 col-form-label" for="val-meta_keywords">meta:keywords</label>
                                    <div class="col-lg-8">
                                        <input type="text" class="form-control" id="val-meta_keywords" name="page[{$lg}][meta_keywords]" value="" placeholder="mmoweb, mmoweb4">
