    ...
    $('body').on('click', '.submit-btn, .submit-form', function (e) {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                ...
                if (elBlock.length){ elBlock.toggleClass('block-mode-loading'); }
            ...
            error: function (xhr, ajaxOptions, thrownError) {
                ...
                if (elBlock.length){ elBlock.removeClass('block-mode-loading'); }
            ...
            if(response.html !== undefined) {
                if (response.html_div !== undefined) {
                    ...
                    if($(response.html_div).is("input"))
                        $(response.html_div).val(response.html);
                    else
