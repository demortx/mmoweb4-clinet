...
return array(
    ...
    'en' => array(
        ...
        'support_ajax_empty_tid' => 'Ticket ID not transferred',
        'support_ajax_empty_category' => 'You need to select the tech support subject',
        'support_ajax_empty_details' => 'Message details not sent',
        'support_ajax_empty_title' => 'Tech support subject is not transferred',
        'support_ajax_empty_message' => 'Tech support Comment is not transferred',

        'title_awaiting_user' => 'Awaiting Response',
        'title_awaiting_admin' => 'Processing',
        'title_closed' => 'Closed',
        'title_msg_empty' => 'No messages',

        'tabs_all_ticket' => 'All messages',
        'tabs_create_ticket' => 'Create ticket',

        'btn_create_ticket_1' => 'Create ticket',
        'btn_create_ticket_2' => 'Common questions',

        'btn_create_donate_1' => 'Problems',
        'btn_create_donate_2' => 'with Donate',

        'btn_create_lost_1' => 'Lost',
        'btn_create_lost_2' => 'items',

        'title_create_ticket' => 'Create a new ticket to the specified department',

        'title_create_category_6' => 'Missing items',
        'title_create_category_7' => 'Bot complaint',
        'title_create_category_8' => 'Top up balance problems',



        'form_title_category' => 'Topic',
        'form_title_account' => 'Account',
        'form_title_char' => 'Character',
        'form_title_char_select' => 'Choose character',
        ...
        'form_title_yse' => 'Yes',
        'form_title_yse_text' => 'Attention, if other players had authorized access to your account, then stolen items will not be returned. In this case, it is possible to conduct an investigation and report the result to you. The cost of the service is individual',
        'form_title_no' => 'No',
        'form_title_no_text' => 'Attention, if as a result of the investigation it becomes clear that other players had access to the account authorized by you, then this fact will be considered as an attempt to deceive the administration. In this case, you will face a blocking of the game account in accordance with the established rules.',
        'form_title_protection' => 'Has account protection been enabled?',
        'form_title_loss' => 'Estimated date of loss',
        'form_title_contact' => 'Communication method',
        'form_title_message_loss' => 'Specify a list of missing items',
        'form_title_message_loss_desc' => 'The magic sword is gone',

        //проблема с платежом
        'form_title_payment_method' => 'Choose a payment system',
        ...
        'form_title_message_comment' => 'Comments',
        'form_title_message_comment_text' => 'Comments...',


        //найден бот
        'form_title_date' => 'Intruder Detection Date',
        'form_title_time' => 'Time',
        'form_title_bot_name' => 'List the nicknames of intruders',
        'form_title_message_bot' => 'Comment, link to screenshots...',



        'form_title_message' => 'Message',
        'form_title_message_text' => 'Problem description...',




        'form_title_send_btn' => 'Send',
        ...
        'category' => array(
            ...
            3 => 'Client mistakes',
            4 => 'Game bugs',
            5 => 'Account/character suspension',
            6 => 'Missing items',
            7 => 'Bot complaint',
            8 => 'Top up balance problems',
            9 => 'Other',
        ),
