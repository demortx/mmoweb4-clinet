...
class Captcha
{
    public function prime($length = 3)
    {
    ...
    public function draw($width = 125, $height = 34, $fontsize = 18, $font = ROOT_DIR . VIEWPATH . "/panel/assets/fonts/captcha/comic.ttf")
    {
        ...
        if (isset($_SESSION['captcha'])) {
            ...
            $background =  ROOT_DIR . VIEWPATH ."/panel/assets/media/captcha/captcha-back.jpg";
